...
export function Careers() {
  return (
    <Section id="careers" theme="dark">
      ...
      <h2 className="mt-5 max-w-[18ch] font-display text-[clamp(32px,4.2vw,52px)] font-bold leading-[1.1] tracking-tight text-dark-hi">
        {careers.title}
      </h2>
      ...
      <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {careers.pillars.map((p, i) => (
          <Reveal
            ...
            className="border border-t-2 border-dark-border border-t-gold bg-dark-card p-7"
          >
